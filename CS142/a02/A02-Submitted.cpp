...
public:
  ...
  Song(std::string title) : Title(title), Artist("unknown"), Year(-1) {}
  Song(std::string title, std::string artist, int year) : Title(title), Artist(artist), Year(year) {}
